  ...
  return (
    <div className="text-white h-auto py-6 my-10">
      <div className="container mx-auto">
        <h1 className="text-4xl font-bold mb-4 underline">About RoshanBlog</h1>
        <p className="text-gray-300">
          Welcome to RoshanBlog, a place where we share our thoughts, ideas, and
        ...
        <p className="text-gray-300 mt-4">
          ...
          Whether you're a seasoned writer or new to blogging, RoshanBlog offers
